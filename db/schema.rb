...
ActiveRecord::Schema.define(version: 2024_03_13_082334) do
  ...
  create_table "game_bookmarks", force: :cascade do |t|
  ...
  add_foreign_key "relationships", "end_users", column: "followees_id"
